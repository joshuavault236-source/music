module.exports = {
    ...
    stats: {
        ...
        header: {
            title: "# ボット統計",
            botName: "**{botName}** - プライムミュージックボット",
            developer: "ShadowBlack / https://github.com/Shadow-Black-YT によって開発"
        },
        botInfo: {
            title: "## ボット情報",
            servers: "• **サーバー:** {count}",
    ...
    music: {
        ...
        clear: {
            command: {
                name: "clear",
                description: "キュー全体をクリア"
            },
            success: {
                title: "## 🗑️ キューがクリアされました",
                message: "キューから **{count}** 曲が正常に削除されました。",
                note: "現在再生中の曲は続行されます。"
            },
            errors: {
                title: "## ❌ エラー",
                message: "キューのクリア中にエラーが発生しました。\n後でもう一度お試しください。"
            }
        },
        stop: {
            command: {
