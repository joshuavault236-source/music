    ...
    music: {
        ...
        clear: {
            ...
            success: {
                ...
                message: "**{count}** Song{plural} erfolgreich aus der Warteschlange entfernt.",
                note: "Der aktuell abgespielte Song wird fortgesetzt."
            },
            errors: {
                title: "## ❌ Fehler",
                message: "Beim Leeren der Warteschlange ist ein Fehler aufgetreten.\\nBitte versuche es später erneut."
            }
        },
        stop: {
            command: {
