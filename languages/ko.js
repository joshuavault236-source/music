module.exports = {
    ...
    stats: {
        ...
        header: {
            title: "# 봇 통계",
            botName: "**{botName}** - Prime Music Bot",
            developer: "ShadowBlack / https://github.com/Shadow-Black-YT 개발"
        },
        botInfo: {
            title: "## 봇 정보",
            servers: "• **서버:** {count}",
    ...
    music: {
        ...
        clear: {
            command: {
                name: "clear",
                description: "전체 대기열 지우기"
            },
            success: {
                title: "## 🗑️ 대기열 지워짐",
                message: "대기열에서 **{count}**개의 노래가 성공적으로 제거되었습니다.",
                note: "현재 재생 중인 노래는 계속됩니다."
            },
            errors: {
                title: "## ❌ 오류",
                message: "대기열을 지우는 중 오류가 발생했습니다.\n나중에 다시 시도해 주세요."
            }
        },
        stop: {
            command: {
